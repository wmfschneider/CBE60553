...
\label{sec:org886dc8c}
\subsection{Problems and Postulates}
\label{sec:orgdfba33c}
\begin{enumerate}
...
\begin{enumerate}
\item Cyclic, so ideal efficiency independent of working fluid
\end{enumerate}
...
\label{sec:org5265cf4}
\begin{enumerate}
\item Fundamental equation
\item Work of separation
\end{enumerate}

\subsection{van der Waals gas}
\label{sec:org4ecec86}
\begin{enumerate}
...
\label{sec:org544e7b1}
\subsubsection{Partition function}
\label{sec:orgf280f13}
\begin{enumerate}
...
\label{sec:org2274a44}
\subsubsection{Separability}
\label{sec:org9bc381b}
    \begin{displaymath}
...
\label{sec:org1012e3f}
\subsubsection{Virial expansion}
\label{sec:orge776225}
\begin{enumerate}
...
\label{sec:org7b3416b}
\subsubsection{Ideal gas mixtures}
\label{sec:orgc74c23f}
\begin{enumerate}
